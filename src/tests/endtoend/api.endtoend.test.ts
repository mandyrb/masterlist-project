...
describe("API Endpoints", () => {
  it("should handle CRUD operations", async () => {
    ...
    const badReadResponseTwo = await request(API_URL).get(`/${shortId}`);
    ...
    // Delete the object
    const deleteResponse = await request(API_URL).delete(`/${id}`);
